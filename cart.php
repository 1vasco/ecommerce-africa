...
<head>
	...
	<title>Carrinho | Moda Africana</title>
...
<body>
					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="login.php"><i class="fa fa-lock"></i> <?php
																					if (isset($_SESSION['usuarioId'])  > 0) {
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Moda Africana<i class="fa fa-angle-down"></i></a>
									<ul role="menu" class="sub-menu">
										<li><a href="shop.php">Produtos</a></li>
										<li><a href="product-details.php">Detalhes do produto</a></li>
		...
		<section id="cart_items">
			<div class="container">
				<div class="breadcrumbs">
					<ol class="breadcrumb">
						<li><a href="index.php">Pagina Inicial</a></li>
						<li class="active">Aza Carrinho</li>
					</ol>
				</div>
						...
						<tbody>
							...
							if (!isset($_SESSION['carrinho'])) {
								...
								foreach ($_SESSION['carrinho'] as $id => $qtd) {
									...
									$total_form = number_format($total_final, 2, ',', '.');

									echo "

						 <tr>
						 <td class='cart_product'>
							 <a href=''><<img style='height:200px;' src='upload_img/" . $data['imagem'] . ".jpg' alt='' /></a>
						 </td>
						 <td class='cart_description'>
							 <h4><a href=''><p>Produto:</p> $produto</a></h4>
							 <p>ID: $id</p>
						 </td>
						 <td class='cart_price'>
							 <p>$preco</p>
						 ...
						 <td class='cart_total'>
							 <p class='cart_total_price'>  $total_form kz</p>
						 </td>
						 <td class='cart_delete'>
							 <a class='cart_quantity_delete' href='?acao=del&id=" . $data['id'] . "'><i class='fa fa-times'></i></a>
						 </td>
					 </tr>
						";
								}
	...
	<section id="do_action">
		<div class="container">
			...
			<a href="checkout.php"> <button class="btn btn-danger"> Encomendar</button> </a>
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2><span>e</span>-Moda Africana</h2>
							<p>Vestir bem, faz bem. Moda Africana proporciona bom humor e carisma para os esus clientes</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
