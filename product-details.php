...
<head>
    ...
    <title>Detalhes do produto | Moda Africana</title>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Moda Africana<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="product-details.php" class="active">Detalhes de Produtos</a></li> 
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Festas</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
				...
				if($data['qtd']==0){
					echo"   						
							...
							<img style='height:200px;' src='upload_img/".$data['imagem'].".jpg' alt='' />
								<p>Descrição do produto<h2>".$data['descricao']."</h2></p>
								<p>Nome: ".$data['nome']."</p>
								<img src='images/home/".$data['imagem'].".jpg' alt='' />
								<img src='images/product-details/rating.png' alt=' />
								<span>
									<span>US ".$data['precoUnitario']."</span>
									<label>Quantity:</label>
									<input type='text' value='3' />
									<button type='button' class='btn btn-fefault cart'>
									<a href='?acao=add&id=".$data['idp']."<i class='fa fa-shopping-cart'></i>
										Adicionar no carrinho
									</button></a>
								</span>
								<p><b>Disponibilidade:</b> <font color='red'> ESGOTADO </font></p>
								<p><b>Preço:</b> ".number_format($data['precoUnitario'],2,',','.')." kz</p>
					...
					echo"   						
							...
							<img style='height:200px;' src='upload_img/".$data['imagem'].".jpg' alt='' />
								...
								<p><b>Disponibilidade:</b> ".$data['qtd']."</p>
								<p><b>Preço:</b> ".number_format($data['precoUnitario'],2,',','.')." kz</p>
