				...
				<div class="row">
					<div class="col-sm-6 ">
						<div class="contactinfo">
							...
							<?php 
								if(isset($_SESSION['usuarioPrivilegio']) == 0){
								echo "$Semail"; 
					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="login.php"><i class="fa fa-lock"></i> Sair</a></li>
							</ul>
						</div>
					</div>
				</div>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#" class="active">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="shop.php" class="active">Produtos</a></li>
							...
							<div class='product-image-wrapper'>
								<div class='single-products'>
									<div class='productinfo text-center'>
										<img src='upload_img/".$data['imagem'].".jpg' alt='' />
									...
									<div class='product-overlay'>
										<div class='overlay-content'>
											<h2>".$data['precoUnitario']." Kz</h2>
											<p>".$data['nome']."</p>
											<a href='?acao=add&id=".$data['idp']."' class='btn btn-default add-to-cart'><i class='fa fa-shopping-cart'></i>Adicionar no carrinho</a>
										</div>
									</div>
								</div>
								<div class='choose'>
