					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>E</span>-Moda Africana</h1>
									<button type="button" class="btn btn-default get">Obtê-lo agora</button>
								</div>
								<div class="col-sm-6">
							...
							<div class="item">
								<div class="col-sm-6">
									...
									<button type="button" class="btn btn-default get">Obtelo Agora</button>
								</div>
								<div class="col-sm-6">
